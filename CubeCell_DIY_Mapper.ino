...
uint8_t devEui[] = { 0xB0, 0x3B, 0x72, 0xEC, 0x6A, 0xCB, 0x57, 0x24 };
uint8_t appEui[] = { 0x6A, 0x9E, 0xE7, 0xBD, 0xC8, 0xDF, 0xEC, 0x69 };
uint8_t appKey[] = { 0xD7, 0xD6, 0xDD, 0xA3, 0x3E, 0x83, 0x08, 0xCD, 0x4A, 0x85, 0xF2, 0xD7, 0xB2, 0x15, 0xE1, 0x7E };
