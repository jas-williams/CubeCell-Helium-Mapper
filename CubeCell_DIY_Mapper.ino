...
uint8_t devEui[] = { 0x1C, 0x3D, 0xE2, 0x1A, 0xDF, 0x06, 0x1C, 0x43 };
uint8_t appEui[] = { 0x8E, 0x96, 0x74, 0xCE, 0x7B, 0x93, 0x5B, 0xAE };
uint8_t appKey[] = { 0xE1, 0x2A, 0x42, 0x3B, 0xAC, 0x0D, 0x27, 0xCD, 0x0A, 0x2F, 0xBF, 0xD4, 0xDB, 0x7D, 0x8F, 0x3F };
